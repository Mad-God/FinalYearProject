...
SECRET_KEY = 'django-insecure-8eppl9s0zth8_3j&9!1zoa0#t^h)g!iq1zz%#_i+^rb&+1&&q5'
...
STATICFILES_DIRS = [
    ...
    # os.path.join(BASE_DIR,'shop/static/slides/'),

]
STATIC_ROOT = 'static_root'
AUTH_USER_MODEL = 'base.User'

# to just log the mail to the console
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
# to send the mail over SMTP protocol, which will need credentials for SMTP
